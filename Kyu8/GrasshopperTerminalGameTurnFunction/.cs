...
namespace Game
{
    public static class Logic
    {
        ...
        public static void RollDice() => Log.Add(nameof(RollDice));
        public static void Move() => Log.Add(nameof(Move));
        public static void Combat() => Log.Add(nameof(Combat));
        public static void GetCoins() => Log.Add(nameof(GetCoins));
        public static void BuyHealth() => Log.Add(nameof(BuyHealth));
        public static void PrintStatus() => Log.Add(nameof(PrintStatus));
    }
}
